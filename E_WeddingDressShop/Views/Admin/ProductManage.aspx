...
<body>
    <form id="form1" runat="server">
        ...
        <div class="grid-container">
            ...
            <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" AllowPaging="True" PageSize="5" OnPageIndexChanging="gvProducts_PageIndexChanging">
                <Columns>
